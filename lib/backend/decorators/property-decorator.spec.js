...
var _baseProperty = _interopRequireWildcard(require("../adapters/base-property"));
...
describe('PropertyDecorator', function () {
  beforeEach(function () {
    this.property = new _baseProperty.default({
      path: 'name',
      type: _baseProperty.PropertyType.string
    });
  ...
  fields.forEach(field => {
    describe(`#${field}`, function () {
      it('passess the execution to the overrideFromOptions', function () {
        ...
        (0, _chai.expect)(stub).to.have.been.calledWith(field);
      });
    });
  });

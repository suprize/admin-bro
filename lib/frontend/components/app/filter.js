...
})(["background:", ";flex-shrink:0;width:", ";border-left:1px solid ", ";color:#fff;padding-top:60px;transition:width 0.5s;position:absolute;top:0;right:0;bottom:0;overflow-x:hidden;overflow-y:scroll;display:flex;&.filter-hidden{width:0;transition:width 0.5s;}"], ({
  theme
...
})(["padding:", ";width:", ";min-width:", ";overflow:hidden;& a,& button{margin:", " 0;width:100%;}"], ({
  theme
